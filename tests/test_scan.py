...
def _payload(symbol, direction, rsi=60.0, squeeze_on=True):
    return {
...
def test_rank_fired_orders_bull_before_bear_then_by_rsi_distance():
    payloads = [
        _payload("BEAR1", "bear", rsi=40.0),
        _payload("BULLWEAK", "bull", rsi=55.0),
        _payload("BULLSTRONG", "bull", rsi=68.0),
    ]
